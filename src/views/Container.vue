<template>
  <div id="container">
    <transition-group appear name="in-move-left-out-move-left" mode="out-in">
      <welcome v-if="showWelcome" data-testid="welcome" />
      <question v-if="showQuestion && nextPrompt" :prompt="nextPrompt" data-testid="question" />
      <finished v-if="showFinished" data-testid="finished" />
    </transition-group>
  </div>
</template>
