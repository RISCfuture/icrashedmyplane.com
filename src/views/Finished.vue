<template>
  <div class="level-description">
    <accident v-if="isAccident" data-testid="accident" />
    <serious-incident v-else-if="isSeriousIncident" data-testid="serious-incident" />
    <incident v-else data-testid="incident" />
    <footer>
