...
const en: LocaleMessage = {
  ...
  welcome: {
    ...
    footer:
      'This website was created by {me} during the COVID-19 shelter-in-place order of April 2020.',
  },
  finished: {
    incident: {
    ...
    immediateNotification: {
      ...
      contact:
        'Contact information for regional offices can be found at {URL}.' +
        ' You can also call the NTSB Response Operations Center at (844) 373-9922 or (202) 314-6290.',
      whatToInclude:
        'You should reference 49 CFR § 830.6 for what to include in your notification.',
    },
    accidentReport: {
      title: 'Accident Report',
      description:
        'You are required to make a report of this accident to the NTSB within 10 days' +
        ' after the accident.',
      form:
        'You must fill out {form6120} or 6120.2 (OMB No. 3147-0001). Send the completed form to' +
        ' the applicable address shown in  the form description.',
      form6120: 'NTSB Form 6120.1',
    },
    disclaimer:
      'Important disclaimer: This website should not be used as a source for legal advice.' +
      ' Consult an aviation attorney.',
    applicableRegulations:
      'The regulations that apply to your incident are 49 CFR § {regulations}.',
  },
}
export default en
