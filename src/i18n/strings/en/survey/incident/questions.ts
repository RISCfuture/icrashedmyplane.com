...
const questions: LocaleMessage = {
  aircraftMajorDamage: 'Which parts of the aircraft received major damage?',
  complianceNecessary:
    'Was compliance with the resolution advisory necessary to avoid a potential collision?',
  ...
  electricContinuous:
    'Did you have to continually use an emergency bus powered by a backup power source?',
  ...
  hydraulicContinuous:
    'Did you have to continually use the remaining hydraulic systems, or a mechanical system?',
  ...
  root: 'What happened?',
  severe: 'Was the hemorrhage classified as severe?',
